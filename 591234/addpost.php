...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    $wods_limit = 6;
    $getNewsPostMsg = $post->getNewsPostInsert($_POST, $_FILES, $wods_limit);
}
        ...
        <section class="col-md-12 connectedSortable">
          ...
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                  <select class="form-control selectedStyle" name="catId">
                    <option value="" style="display: none" selected hidden>Select News Category</option>
                    <?php
            ...
            <input type="hidden" name="c_date" value="<?php
          ...
          <!-- /.form group -->
           ...
           <div class="form-group">
              ...
              <label class="radio-inline"><input type="radio" name="optradio" value="1" checked="">সাধারণ সংবাদ</label>
