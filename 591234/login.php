  ...
  <!-- /.login-logo -->
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
      ...
      <div class="row ligin_bottom_bta">
        ...
        <!-- /.col -->
        <div class="col-xs-6">
          <button type="submit" name="login_admin" onclick="return validate();" class="btn btn-success btn-block">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
      <div class="row ligin_bottom_bt">
        <div class="col-xs-12">
           <button type="submit" name="login_admin" onclick="return validate();" class="btn btn-success btn-block espacebottom">Sign In</button>
        </div>
        <!-- /.col -->
        <div class="col-xs-12">
          <a href="#" class="btn btn-default btn-block">Forgot Password</a>
